...
<link rel="stylesheet" type="text/css" href="CSS/boardCSS.css?ver=2">
	...
	<div id="board_wrap">
		<div class="common_set">
			<form action="check.jsp" method="post">
				아이디&nbsp&nbsp&nbsp<input id="id" type="text" name="id" size="30"><br><br>
				...
				<input type="submit" name="a" value="보내기">
			</form>
			<script>
